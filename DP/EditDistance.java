...
public class EditDistance {
    private int helper(int i, int j, String word1, String word2, int[][] dp) {
        ...
        return dp[i][j] = 1 + Math.min(helper(i, j - 1, word1, word2, dp),Math.min(helper(i - 1, j, word1, word2, dp),helper(i - 1, j - 1, word1, word2, dp)));
    }
    ...
    private int helper1(int i, int j, String word1, String word2, int[][] dp) {
        ...
        return dp[i][j] = 1 + Math.min(helper1(i-1, j, word1, word2, dp), Math.min(helper1(i, j-1, word1, word2, dp), helper1(i-1, j-1, word1, word2, dp)));
    }
}
